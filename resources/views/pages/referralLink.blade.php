...
<main>
  <div class="row">
    ...
    <div id="tab1" class="col l9 m8 s12"> 
    @include('link.buahmerah')
    </div>
    <div id="tab2" class="col l9 m8 s12">
    @include('link.company')
    </div>
    <div id="tab3" class="col l9 m8 s12">
    @include('link.legalities')
    </div>
    <div id="tab4" class="col l9 m8 s12">
    @include('link.awards')
    </div>
    <div id="tab5" class="col l9 m8 s12">
    @include('link.testimonials')
    </div>
    <div id="tab6" class="col l9 m8 s12">
    @include('link.howToDrink')
    </div>
    <div id="tab7" class="col l9 m8 s12">
