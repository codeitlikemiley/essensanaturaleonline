		...
		<table class="bordered highlight responsive-table">
		  ...
		  <tbody>
		    ...
		    <tr>
		      ...
		      <input id="updateQty{{ $item->id }}" name="qty" onchange="updateProduct({{ $item->id }})" value="{{ $item->qty }}" style="width:50px; position:relative; padding-top:-100px; padding-bottom:-100px;" class="qty_input"></input>
			  </form>
		      </td>
