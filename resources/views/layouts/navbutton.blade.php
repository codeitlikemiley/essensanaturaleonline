{{-- Navigation Floating Button --}}
  <div class="fixed-action-btn  click-to-toggle" style="bottom: 40px; right: 50px; z-index: 996;">
    ...
    <ul>
      ...
      <li><a href="#" class="btn-floating red darken-4"><i class="material-icons tooltipped" data-position="left" data-delay="50" data-tooltip="Check Out">local_shipping</i></a></li>
