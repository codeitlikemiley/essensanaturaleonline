  ...
  <nav>
    <div class="nav-wrapper">
      ...
      <ul class="right">
        ...
        @endif
        @if(!Auth::user())
        <li><a href="/shipping-address" id="navbar-login" class="tooltipped" data-position="bottom" data-delay="50" data-tooltip="Click Here to Access Account"><i class="material-icons">account_circle</i></a></li>
        @endif
        @if(Auth::user())
